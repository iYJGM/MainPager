...
public class MusicAdapter extends BaseAdapter implements AbsListView.OnScrollListener{
    ...
    public MusicAdapter(FragmentActivity activity, List<Music> data, ListView listView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.ivIcon = (ImageView) convertView.findViewById(R.id.iv_artist);
            holder.tvTitle = (TextView) convertView.findViewById(R.id.tv_music_title);
            holder.tvContent = (TextView) convertView.findViewById(R.id.tv_music_author);
            holder.duration = (TextView) convertView.findViewById(R.id.tv_time);
    ...
    class ViewHolder
    {
        ...
        public TextView tvTitle, tvContent,duration;
    }
    /*
     * 当listview滑动的时候调用
     */
